...
Live deployment at [ln.seedhypermedia.com](https://ln.seedhypermedia.com).
...
Both incoming and outgoing keysend payments are supported. For outgoing keysend payments, check out the [API documentation](https://ln.seedhypermedia.com/swagger/index.html#/Payment/post_keysend).
