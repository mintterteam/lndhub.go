...
type Config struct {
	...
	DefaultRateLimitPerMin int    `envconfig:"DEFAULT_RATE_LIMIT_PER_MIN" default:"60"`
	DefaultRateLimitPerSec int    `envconfig:"DEFAULT_RATE_LIMIT_PER_SEC" default:"4"`
	StrictRateLimitPerMin  int    `envconfig:"STRICT_RATE_LIMIT_PER_MIN" default:"30"`
	StrictRateLimitPerSec  int    `envconfig:"STRICT_RATE_LIMIT_PER_SEC" default:"1"`
